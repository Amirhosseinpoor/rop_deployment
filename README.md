...
also the pictures or other requiered assets are placed in static file 
1) an upload page ( the user can only upload a picture here)
2) after submiting the user will be redirected to the results page ( + it may take a while so you should puy a spinner, loader bar, or anything else that you think is appropriate)
3) next, there is a page that carry results ( now both the upload page and results page place in index.html code)
