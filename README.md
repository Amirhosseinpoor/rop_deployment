...
4.2) then, beneath the segmented eye pictuerr is 4 parts or boxes for text-based results that our pipeline had processed(plus, stage, and zone prediction, as well as final decision)( each of them has a percentage as their accuracy + final decision has a text for treatment) 
